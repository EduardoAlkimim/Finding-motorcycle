export const USUARIOS = [
  ...
  { id: '3', nome: 'Carlos Moto', email: 'moto1@autopecas.com', perfil: 'MOTOQUEIRO', motoId: 'm1' },
  { id: '4', nome: 'Pedro Moto', email: 'moto2@autopecas.com', perfil: 'MOTOQUEIRO', motoId: 'm2' },
];

export const MOTOS = [
  { id: 'm1', placa: 'ABC1D23', apelido: 'Moto 01', cor: '#185FA5', motoqueiroId: '3', motoqueiro: 'Carlos Moto' },
  { id: 'm2', placa: 'XYZ9W87', apelido: 'Moto 02', cor: '#0F6E56', motoqueiroId: '4', motoqueiro: 'Pedro Moto' },
];
...
export const LOCAIS = [
  ...
  { id: 'l3', nome: 'Garagem do Pedro',      endereco: 'Quadra 15, Bloco B',   lat: -15.8100, lng: -47.9000 },
...
export const ALERTAS = [
  { id: 'a1', tipo: 'DESVIO_ROTA',         descricao: 'Moto 01 rodou 2,8km acima do previsto na NF-2024-002', lido: false, criadoEm: '10:02' },
  { id: 'a2', tipo: 'CONFIRMACAO_SEM_GPS', descricao: 'Confirmação sem GPS detectada — NF-2024-003, local Garagem do Pedro', lido: false, criadoEm: '08:35' },
];
